...
export default function EditRealEstateDealPage() {
  ...
  const [deal, setDeal] = useState<RealEstateDeal | null>(null)
  ...
  useEffect(() => {
    const fetchDeal = async () => {
      ...
      if (error) {
        ...
        alert("Error fetching deal. Please try again.")
      ...
      if (data) {
        ...
        setFormData({
          ...
          number_of_floors: data.number_of_floors?.toString() || "",
          primary_color: data.primary_color || "",
          number_of_entrances: data.number_of_entrances?.toString() || "",
          air_system: data.air_system || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        alert("Error updating real estate deal. Please try again.")
      } else {
        router.push("/admin/real-estate-deals")
      }
    } catch (error) {
    ...
    return (
      <div className="p-6">
        <div className="text-center py-8">
          ...
          <p className="mt-4 text-[#001934]">Loading deal...</p>
        </div>
      </div>
    )
  }
  ...
  if (!deal) {
    return (
      <div className="p-6">
        <div className="text-center py-8">
          <h2 className="text-2xl font-bold text-red-600 mb-4">Deal Not Found</h2>
          <p className="text-gray-600 mb-4">The real estate deal you're looking for doesn't exist.</p>
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[#001934]">Edit Real Estate Deal</h1>
                ...
                <label htmlFor="main_image" className="cursor-pointer">
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#B8860B] transition-colors">
                    ...
                    <p className="text-sm text-gray-600">
                      {mainImageFile ? mainImageFile.name : "Click to upload new main image"}
                    </p>
