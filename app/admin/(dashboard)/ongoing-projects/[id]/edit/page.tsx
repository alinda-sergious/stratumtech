...
export default function EditOngoingProjectPage() {
    ...
    const fetchProject = async () => {
      try {
        ...
        if (data) {
          ...
          setItinerary(data.itinerary || [{ day: 1, title: "", description: "" }])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Ongoing project updated successfully!")
      setTimeout(() => {
        router.push("/admin/ongoing-projects")
      }, 2000)
    } catch (err: any) {
      setError(err.message || "Failed to update ongoing project")
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[#001934]">Edit Ongoing Project</h1>
